...
exports.makeNodeFabric = undefined;
exports.fullNodeFabric = fullNodeFabric;
...
var makeNodeFabric = exports.makeNodeFabric = e => nextVal => new SolidNode(nextVal, e);

function fullNodeFabric(instance) {
  /*::
  const { next, value } = instance
  */
  function FullNodeInstance(back) {
    this.back = back;
    /*::
    this.next = next
    this.value = value
  ...
  return back => new FullNodeInstance(back);
}
